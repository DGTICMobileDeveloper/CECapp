...
public class Constants {
    ...
    public static final String BASE_LINK_INTERESTS = "http://132.248.108.6/cec/Controladores/listSubjects.php";
    public static final String BASE_LINK_GET_USER_EVENTS = "http://132.248.108.6/cec/Controladores/getUserEvents.php";
    public static final String BASE_LINK_REGISTER_USER_TO_EVENT = "http://132.248.108.6/cec/Controladores/addUserToEvent.php";
    public static final String BASE_LINK_REMOVE_USER_FROM_EVENT = "http://132.248.108.6/cec/Controladores/removeUserFromEvent.php";
    public static final String BASE_LINK_REGISTER_USER = "http://132.248.108.6/cec/Controladores/addUser.php";
    public static final String BASE_LINK_UPDATE_USER = "http://132.248.108.6/cec/Controladores/updateUser.php";
    public static final String BASE_LINK_SEARCH_EVENT = "http://132.248.108.6/cec/Controladores/searchEvents.php";
    public static final String BASE_LINK_GET_EVENT_MAP= "http://132.248.108.6/cec/Controladores/getDataMap.php";
    //public static final String BASE_LINK_CLEAR_USERS = "http://132.248.108.6/cec/Controladores/deleteUsers.php";
